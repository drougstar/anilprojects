...
const CACHE = 'ifsbridge-v58-test-1';
...
SHELL.push('./js/import-categories.js', './js/import-ai.js');
SHELL.push('./js/bank-periods.js');
SHELL.push('./js/bank-period-groups.js', './js/personal-categories.js', './js/personal-category-save.js');
...
SHELL.push('./js/personal-reset.js');
SHELL.push('./js/app-navigation.js');
